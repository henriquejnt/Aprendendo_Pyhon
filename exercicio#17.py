...
litros = round(tamanho / 6)
latas = round(litros / 18)
galoes = round(litros / 3.6)
print(f'Será necessário {litros} litros de tinta para pintar essa área.')
print(f'Com esse tamanho da área irá precisar {latas} latas')
print(f'Com esse tamanho da área irá precisar {galoes} galões')